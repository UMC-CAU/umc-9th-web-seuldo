  ...
  if (isPending) {
    return (
      <div className="bg-black min-h-screen flex justify-center items-start py-10 px-4">
        <div className="w-full max-w-3xl bg-[#1C1C1C] rounded-2xl shadow-lg p-8 sm:p-10 animate-pulse">
          ...
          <div className="w-3/4 h-6 bg-gray-600 rounded mx-auto mb-10" />

          <div className="w-3/4 aspect-square bg-gray-800 rounded-xl mb-10 flex items-center justify-center mx-auto">
          </div>
